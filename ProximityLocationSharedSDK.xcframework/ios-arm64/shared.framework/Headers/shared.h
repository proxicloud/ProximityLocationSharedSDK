...
@class SharedBeaconScan, SharedKotlinx_datetimeLocalDateTime, SharedHistoryBody, SharedKtor_client_coreHttpResponse, SharedKotlinx_datetimeMonth, SharedKotlinx_datetimeLocalDateTimeCompanion, SharedKotlinx_datetimeLocalDate, SharedKotlinx_datetimeDayOfWeek, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKtor_client_coreHttpClientCall, SharedKtor_utilsGMTDate, SharedKtor_httpHttpStatusCode, SharedKtor_httpHttpProtocolVersion, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKotlinx_datetimeLocalDateCompanion, SharedKtor_client_coreHttpClientCallCompanion, SharedKtor_client_coreTypeInfo, SharedKtor_client_coreHttpClient, SharedKtor_ioMemory, SharedKtor_ioIoBuffer, SharedKotlinByteArray, SharedKotlinUnit, SharedKtor_ioByteReadPacket, SharedKtor_ioByteOrder, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsWeekDay, SharedKtor_utilsMonth, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_utilsAttributeKey<T>, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_client_coreHttpRequestBuilder, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpSendPipeline, SharedKtor_httpOutgoingContent, SharedKtor_httpHttpMethod, SharedKtor_httpUrl, SharedKtor_ioMemoryCompanion, SharedKtor_ioBufferCompanion, SharedKtor_ioBuffer, SharedKtor_ioChunkBuffer, SharedKtor_ioChunkBufferCompanion, SharedKotlinCharArray, SharedKtor_ioIoBufferCompanion, SharedKotlinByteIterator, SharedKtor_ioAbstractInputCompanion, SharedKtor_ioAbstractInput, SharedKtor_ioByteReadPacketBaseCompanion, SharedKtor_ioByteReadPacketBase, SharedKtor_ioByteReadPacketPlatformBase, SharedKtor_ioByteReadPacketCompanion, SharedKtor_ioByteOrderCompanion, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonthCompanion, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKotlinKTypeProjection, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreProxyConfig, SharedKtor_httpHeadersBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_httpURLBuilder, SharedKotlinAbstractCoroutineContextElement, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedKtor_utilsPipelinePhase, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpResponseContainer, SharedKtor_client_coreHttpSendPipelinePhases, SharedKtor_httpContentType, SharedKtor_httpHttpMethodCompanion, SharedKtor_httpURLProtocol, SharedKtor_httpUrlCompanion, SharedKotlinCharIterator, SharedKotlinKVariance, SharedKotlinKTypeProjectionCompanion, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpParametersBuilder, SharedKtor_httpURLBuilderCompanion, SharedKotlinCancellationException, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKtor_httpHeaderValueParam, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpContentTypeCompanion, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpUrlEncodingOption, SharedKotlinx_coroutines_coreAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodePrepareOp, SharedKotlinx_coroutines_coreAtomicOp<__contravariant T>, SharedKotlinx_coroutines_coreOpDescriptor, SharedKotlinx_coroutines_coreLockFreeLinkedListNode, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAbstractAtomicDesc, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeAddLastDesc<T>, SharedKotlinx_coroutines_coreLockFreeLinkedListNodeRemoveFirstDesc<T>;

@protocol SharedKotlinComparable, SharedKtor_httpHeaders, SharedKtor_httpHttpMessage, SharedKotlinCoroutineContext, SharedKotlinx_coroutines_coreCoroutineScope, SharedKtor_ioByteReadChannel, SharedKotlinx_serialization_coreKSerializer, SharedKotlinIterator, SharedKotlinMapEntry, SharedKtor_utilsStringValues, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKtor_utilsTypeInfo, SharedKtor_utilsAttributes, SharedKtor_client_coreHttpRequest, SharedKtor_ioReadSession, SharedKotlinSuspendFunction1, SharedKotlinAppendable, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinKType, SharedKotlinKClass, SharedKtor_ioCloseable, SharedKtor_client_coreHttpClientEngine, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_ioObjectPool, SharedKtor_ioInput, SharedKtor_ioOutput, SharedKotlinFunction, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinKClassifier, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKtor_client_coreHttpClientFeature, SharedKtor_httpHttpMessageBuilder, SharedKotlinx_coroutines_coreJob, SharedKotlinContinuation, SharedKotlinContinuationInterceptor, SharedKotlinx_coroutines_coreRunnable, SharedKotlinSuspendFunction2, SharedKtor_httpParameters, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinSequence, SharedKotlinx_coroutines_coreSelectClause0, SharedKotlinx_coroutines_coreParentJob, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinSuspendFunction0;
...
__attribute__((swift_name("Prefs")))
@protocol SharedPrefs
@required
- (int64_t)getIntKey:(NSString *)key __attribute__((swift_name("getInt(key:)")));
- (void)putIntKey:(NSString *)key value:(int64_t)value __attribute__((swift_name("putInt(key:value:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("BeaconScan")))
@interface SharedBeaconScan : SharedBase
- (instancetype)initWithTrigger:(int32_t)trigger pid:(NSString *)pid createdAt:(int64_t)createdAt geohash:(NSString *)geohash mac:(NSString *)mac rssi:(int32_t)rssi frequency:(int32_t)frequency pairingId:(NSString *)pairingId __attribute__((swift_name("init(trigger:pid:createdAt:geohash:mac:rssi:frequency:pairingId:)"))) __attribute__((objc_designated_initializer));
...
- (SharedBeaconScan *)doCopyTrigger:(int32_t)trigger pid:(NSString *)pid createdAt:(int64_t)createdAt geohash:(NSString *)geohash mac:(NSString *)mac rssi:(int32_t)rssi frequency:(int32_t)frequency pairingId:(NSString *)pairingId __attribute__((swift_name("doCopy(trigger:pid:createdAt:geohash:mac:rssi:frequency:pairingId:)")));
...
@property (readonly) NSString *geohash __attribute__((swift_name("geohash")));
...
@property (readonly) int32_t trigger __attribute__((swift_name("trigger")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HistoryBody")))
@interface SharedHistoryBody : SharedBase
- (instancetype)initWithScans:(NSArray<SharedBeaconScan *> *)scans actions:(NSArray<SharedBeaconScan *> *)actions conversions:(NSArray<SharedBeaconScan *> *)conversions deviceTimestamp:(SharedKotlinx_datetimeLocalDateTime *)deviceTimestamp __attribute__((swift_name("init(scans:actions:conversions:deviceTimestamp:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedBeaconScan *> *)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedBeaconScan *> *)component2 __attribute__((swift_name("component2()")));
- (NSArray<SharedBeaconScan *> *)component3 __attribute__((swift_name("component3()")));
- (SharedKotlinx_datetimeLocalDateTime *)component4 __attribute__((swift_name("component4()")));
- (SharedHistoryBody *)doCopyScans:(NSArray<SharedBeaconScan *> *)scans actions:(NSArray<SharedBeaconScan *> *)actions conversions:(NSArray<SharedBeaconScan *> *)conversions deviceTimestamp:(SharedKotlinx_datetimeLocalDateTime *)deviceTimestamp __attribute__((swift_name("doCopy(scans:actions:conversions:deviceTimestamp:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedBeaconScan *> *actions __attribute__((swift_name("actions")));
@property (readonly) NSArray<SharedBeaconScan *> *conversions __attribute__((swift_name("conversions")));
@property (readonly) SharedKotlinx_datetimeLocalDateTime *deviceTimestamp __attribute__((swift_name("deviceTimestamp")));
@property (readonly) NSArray<SharedBeaconScan *> *scans __attribute__((swift_name("scans")));
@end;
...
*/
- (void)sendRequestWithCompletionHandler:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendRequest(completionHandler:)")));
- (int32_t)takeOne __attribute__((swift_name("takeOne()")));
- (int32_t)takeZero __attribute__((swift_name("takeZero()")));
@end;
