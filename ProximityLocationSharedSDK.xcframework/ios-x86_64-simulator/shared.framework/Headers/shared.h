...
@class SharedBeaconScan, SharedKotlinx_datetimeLocalDateTime, SharedHistoryBody, SharedKotlinUnit, SharedKotlinx_datetimeMonth, SharedKotlinx_datetimeLocalDateTimeCompanion, SharedKotlinx_datetimeLocalDate, SharedKotlinx_datetimeDayOfWeek, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedKotlinx_datetimeLocalDateCompanion, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedKotlinComparable, SharedKotlinx_serialization_coreKSerializer, SharedKotlinIterator, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
*/
- (void)sendRequestWithCompletionHandler:(void (^)(SharedKotlinUnit * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendRequest(completionHandler:)")));
